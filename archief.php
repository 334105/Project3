...
<head>
    ...
    <link rel="stylesheet" href="./archief/archief.css">
</head>
<body>
    <header>
        <nav>
    ...
    <div class="box3">
    <a class="twitter-timeline" href="https://twitter.com/TwitterDev?ref_src=twsrc%5Etfw">Tweets by TwitterDev</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8" class="twitter-script"></script>
    </div>
